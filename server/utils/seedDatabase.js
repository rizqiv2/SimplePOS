...
const seedDatabase = async () => {
  try {
    ...
    const products = await Product.create([
      ...
      {
        name: 'T-Shirt - Blue',
        description: 'Cotton crew neck t-shirt in blue',
        sku: 'CLO-001',
      ...
      {
        name: 'Jeans - Black',
        description: 'Classic fit denim jeans in black',
        sku: 'CLO-002',
      ...
      },
      {
        ...
        description: 'Premium dark roast coffee beans, 1lb',
        sku: 'FOOD-001',
      ...
      {
        name: 'Energy Drink',
        description: 'Sugar-free energy drink, 16oz',
        sku: 'FOOD-003',
      ...
      },
      {
        ...
        description: 'Medium ceramic plant pot with drainage',
        sku: 'HOME-001',
    ...
    await Customer.create([
      {
        ...
        phone: '555-1001',
        address: '789 Oak Street, Cityville, ST 12345',
        loyaltyPoints: 150,
      ...
      },
      {
        ...
        phone: '555-1002',
        address: '321 Pine Avenue, Townsburg, ST 54321',
        loyaltyPoints: 200,
      ...
      },
      {
        ...
        phone: '555-1003',
        address: '654 Elm Road, Villageton, ST 67890',
        loyaltyPoints: 75,
        totalPurchases: 220.00
      },
      {
        name: 'David Brown',
        email: 'david@example.com',
        phone: '555-1004',
        address: '987 Maple Drive, Hamletville, ST 98765',
        loyaltyPoints: 300,
